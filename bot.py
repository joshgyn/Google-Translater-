...
async def start(client, message):
	await message.reply_text(text =f"Salam,Əziz **{message.from_user.first_name }** 🙋 \n\n __Mən müxtəlif dillərdə insanlara kömək etmək üçün yaradılmış tərcüməçi botam 🙆 \n Ümid edirəm ki,səndə məndən doğru şəkildə yararlanacaqsan__ \n **/help yazaraq məndən necə istifadə edəcəyini öyrən🙆**",reply_to_message_id = message.message_id ,parse_mode="markdown", reply_markup=InlineKeyboardMarkup([ [                    InlineKeyboardButton("Owner" ,url="https://t.me/sammekkim") ],               [InlineKeyboardButton("Creator", url="https://t.me/hasanli517") ],               [InlineKeyboardButton("Məlumat", url="https://telegra.ph/T%C9%99rc%C3%BCm%C9%99%C3%A7im-08-14-2") ]  ]  ) )

@app.on_message(filters.private & filters.command(['help']))
async def help(client, message):
	await message.reply_text(text =f"Salam **{message.from_user.first_name }** 🙋 \n\n **Mən tərcüməçi botam 🙆 \n Sizin işinizi dahada asanlaşdırmaq üçün yaradılmışam. 🙇 \n Mənə tərcümə etmək istədiyin mesajı göndər və tərcümə etmək istədiyin dili seç. **",reply_to_message_id = message.message_id ,parse_mode="markdown", reply_markup=InlineKeyboardMarkup([     [InlineKeyboardButton("Məlumat", url="https://telegra.ph/T%C9%99rc%C3%BCm%C9%99%C3%A7im-08-14-2") ]  ]  ) )
